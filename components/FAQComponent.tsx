  ...
  return (
    <Container maxWidth="md">
      ...
      <Accordion>
        ...
        <AccordionDetails>
          <Typography variant="body1" align="left">
            Look for opportunities on the X/twitter account and turn notifications on. Applications will be open on this site soon. check back regularly.
          </Typography>
        </AccordionDetails>
      </Accordion>
{/* FAQ 6 */}
